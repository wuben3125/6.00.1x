...
def updateHand(hand, word):
    ...
    for key in hand.keys():
        newHand[key] = hand.get(key, 0) - wordDict.get(key, 0)
...
def playHand(hand, wordList, n):
    ...
    * The hand finishes when there are no more unused letters or the user
    ...
    while calculateHandlen(hand) > 0:
        ...
        # Otherwise (the input is not a single period):
            ...
            # Otherwise (the word is valid):
                ...
                totalScore += points
                print(f"{word} earned {points} points. Total: {totalScore} points")
                print()
                # Update the hand 
    ...
    if calculateHandlen(hand) == 0:
        ...
        print("Goodbye!", end = ' ')
    print(f"Total: {totalScore} points")
...
def playGame(wordList):
    ...
    oldHand = {}
    while True:
        userInput = input("Enter n to deal a hand, r to replay the last hand, or e to end game: ")
        if userInput == 'n':
            oldHand = dealHand(HAND_SIZE)
